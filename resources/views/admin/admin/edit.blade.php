            ...
            <div class="ibox-content">
                <form action="/admin/admin/{{$data['id']}}"  enctype="multipart/form-data" class="form-horizontal m-t" id="signupForm" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="username" disabled value="{{$data['username']}}" name="username" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="nickname"  value="{{$data['nickname']}}"  name="nickname"  class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div style="width: 100px;margin-top: 10px">
                                        ...
                                        <img id="finalImg" src="{{ URL::asset($data['img'])}}" width="100%" style="border-radius: 60px">
                                        <input type="text" id="image" name="img" value="{{$data['img']}}" width="100%"  style="display: none;">
...
{{--                    </div>--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="password" value="" name="password" class="form-control" type="password">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="confirm_password" value="" name="password_confirmation" class="form-control" type="password">
                        </div>
                    </div>
