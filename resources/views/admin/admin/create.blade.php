                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div style="width: 160px;margin-top: 10px">
                                <img id="finalImg" src="" width="100%" style="border-radius: 100px">
                                <input type="text" id="image" name="img" value="" width="100%"  style="display: none">
                            </div>
                        </div>
                    </div>
...
<script>
    document.getElementById('sureCut').addEventListener('click', function () {
        ...
        $.ajax({
            ...
            method: "POST",
            data: {"_token":'{{csrf_token()}}','img':initialAvatarURL,'type':'admin'},
            dataType: "json",
