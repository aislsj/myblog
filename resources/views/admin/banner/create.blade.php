            ...
            <div class="ibox-content">
                <form action="/admin/banner" role="form" enctype="multipart/form-data"  class="form-horizontal m-t"  method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="banner_title" name="banner_title" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div style="width: 300px;margin-top: 10px">
                                    ...
                                    <input type="text" id="image" name="banner_img" value="" width="100%"  style="display: none">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input  name="articlelink" class="form-control" type="text" value="" placeholder="填写文章链接时外部链接必须为空">
