    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form action="/admin/sys/slider" role="form" enctype="multipart/form-data"  class="form-horizontal m-t"  method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="username" name="title" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  name="orders" class="form-control" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="col-sm-8">
                                ...
                                <input id="img" value="" type="hidden" name="img">
                                <img id="picshow" src="" style="width:60px">
                            </div>
                        </div>
                    </div>
