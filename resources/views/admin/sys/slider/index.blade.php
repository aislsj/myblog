            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="/admin/sys/slider/create" class="btn btn-primary btn-xs">新增轮播图</a>
                    </div>
                </div>
                            ...
                            @foreach($data as $value)
                                <tr>
                                    ...
                                    <td class="" style="text-align: center">
                                       <img src="{{$value->img}}" style="max-width: 100px">
                                    </td>
                                    <td class="project-completion center">
                                        <small>{{$value->href}}</small>
                                    </td>
                                    <td class="project-completion center">
                                        <small>
                                            {{$value->orders}}
                                    ...
                                    <td class="project-actions" style="text-align: center">
                                        <a href="/admin/sys/slider/{{$value->id}}/edit/"  class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 修改 </a>
