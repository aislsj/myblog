        ...
        <div class="col-sm-10 col-sm-offset-1">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" action="/admin/category/{{$data['id']}}"enctype="multipart/form-data" class="form-horizontal m-t"  method="post">
                    ...
                    @if ($errors->any())
                        ...
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" placeholder="请输入分类名 " value="{{$data['name']}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div style="width: 160px;margin-top: 10px">
                                    @if ($data['image'])
                                        <img id="finalImg" src="{{$data['image']}}" width="100%">
                                        <input type="text" id="image" name="image" value="{{$data['image']}}" width="100%"  style="display: none">
                                    @else
