        ...
        <div class="col-sm-10 col-sm-offset-1">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" action="/admin/life" method="post" enctype="multipart/form-data" class="form-horizontal m-t"  >
                        ...
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="catename" class="form-control" placeholder="请输入分类名 ">
                            </div>
                        </div>
