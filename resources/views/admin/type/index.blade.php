            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="/admin/type/create" class="btn btn-primary btn-xs">新增分类</a>
                    </div>
                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-3" style="text-align: center">
                                        <a href="/admin/type/{{$value->id}}/edit/" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
...
<script>
    function del(obj,id){
        layer.confirm('你确定要删除这条分类吗', {
            ...
            $.post("/admin/type/"+id,{"_token":'{{csrf_token()}}',"_method":"delete"},
                    function(data){
                        //判断是否成功
                        if(data==1){
                            //移除数据
